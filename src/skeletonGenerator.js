...
function createWebProject(context) {
	...
	fileUtils.createNewFileFromTemplate(CSS_PATH, CSS_FILENAME, path.join(context.extensionPath, CSS_TEMPLATE_PATH));

	//Create the js file into the assets/js directory
	fileUtils.createNewFileFromTemplate(JS_PATH, JS_FILENAME, path.join(context.extensionPath, JS_TEMPLATE_PATH));
